...
namespace Softom.Application.UI.Controllers
{
    public class BookingController : Controller
    {
        ...
        public IActionResult FinalizeBooking(Booking booking)
        {
            ...
            if (!_villaService.IsVillaAvailableByDate(villa.VillaId,booking.Nights,booking.CheckInDate))
            {
        ...
        public IActionResult BookingConfirmation(int bookingId)
        {
            ...
            if (bookingFromDb.Status == SD.StatusPending)
            {
                ...
                {
                    _bookingService.UpdateStatus(bookingFromDb.BookingId, SD.StatusApproved,0);
                    _bookingService.UpdateStripePaymentID(bookingFromDb.BookingId,session.Id,session.PaymentIntentId);

                    _emailService.SendEmailAsync(bookingFromDb.Email,"Booking Confirmation - White Lagoon", "<p>Your booking has been confirmed. Booking ID - " + bookingFromDb.BookingId+"</p>");
                }
            }
        ...
        public IActionResult GenerateInvoice(int id, string downloadType)
        {
            ...
            textRange = textSelection.GetAsOneRange();
            textRange.Text = "BOOKING ID - " + bookingFromDb.BookingId;
        ...
        {
            _bookingService.UpdateStatus(booking.BookingId, SD.StatusCheckedIn, booking.VillaNumber);
        ...
        {
            _bookingService.UpdateStatus(booking.BookingId, SD.StatusCompleted , booking.VillaNumber);
        ...
        {
            _bookingService.UpdateStatus(booking.BookingId, SD.StatusCancelled, 0);
