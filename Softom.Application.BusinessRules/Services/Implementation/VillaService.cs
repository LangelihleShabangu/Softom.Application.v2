...
namespace Softom.Application.BusinessRules.Services.Implementation
{
    public class VillaService : IVillaService
    {
        ...
        public bool DeleteVilla(int id)
        {
            try
            {
                Villa? objFromDb = _unitOfWork.Villa.Get(u => u.VillaId == id);
        ...
        {
            return _unitOfWork.Villa.Get(u => u.VillaId == id, includeProperties: "VillaAmenity");
        }
        ...
        public IEnumerable<Villa> GetVillasAvailabilityByDate(int nights, DateOnly checkInDate)
        {
            ...
            foreach (var villa in villaList)
            {
                int roomAvailable = SD.VillaRoomsAvailable_Count
                    (villa.VillaId, villaNumbersList, checkInDate, nights, bookedVillas);
